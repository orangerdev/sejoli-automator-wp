<?php
/**
 * Sejoli Order Anonymous Subscription Tryout
 *
 * @package     AutomatorWP\Integrations\Sejoli\Triggers\Anonymous_Order_Subscription_Tryout
...
class Sejoli_AutomatorWP_Anonymous_Order_Subscription_Tryout extends AutomatorWP_Integration_Trigger {

    public $integration = 'sejoli';
    public $trigger     = 'sejoli_automatorwp_anonymous_order_subscription_tryout';
    ...
    public function listener( $order ) {
        ...
        if ( !is_user_logged_in() ) :
            ...
            if ( empty( $order ) && empty( $order_id ) ) :
                ...
                if( $subscription_type === 'subscription-regular' && $product_type === 'digital' && $subscription_active > 0 && $tryout > 0 ) :
...
new Sejoli_AutomatorWP_Anonymous_Order_Subscription_Tryout();