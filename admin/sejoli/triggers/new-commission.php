<?php
/**
 * Sejoli New Commission
 *
 * @package     AutomatorWP\Integrations\Sejoli\Triggers\New_Commission
...
class Sejoli_AutomatorWP_New_Commission extends AutomatorWP_Integration_Trigger {

    public $integration = 'sejoli';
    public $trigger     = 'sejoli_automatorwp_new_commission';
...
new Sejoli_AutomatorWP_New_Commission();