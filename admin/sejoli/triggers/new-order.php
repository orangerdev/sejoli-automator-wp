 ...
 * Sejoli New Order
 *
 * @package     AutomatorWP\Integrations\Sejoli\Triggers\New_Order
...
class Sejoli_AutomatorWP_New_Order extends AutomatorWP_Integration_Trigger {

    public $integration = 'sejoli';
    public $trigger     = 'sejoli_automatorwp_new_order';
...
new Sejoli_AutomatorWP_New_Order();