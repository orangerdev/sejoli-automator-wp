<?php
/**
 * Sejoli Order Anonymous Subscription Regular
 *
 * @package     AutomatorWP\Integrations\Sejoli\Triggers\Anonymous_Order_Subscription_Regular
...
class Sejoli_AutomatorWP_Anonymous_Order_Subscription_Regular extends AutomatorWP_Integration_Trigger {

    public $integration = 'sejoli';
    public $trigger     = 'sejoli_automatorwp_anonymous_order_subscription_regular';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'If there is a "regular" subscription order type', 'sejoli-automatorwp' ),
            'select_option'     => __( 'If there is a "regular" subscription order type', 'sejoli-automatorwp' ),
            'edit_label'        => __( 'If there is a "regular" subscription order type', 'sejoli-automatorwp' ),
            'log_label'         => __( 'If there is a "regular" subscription order type', 'sejoli-automatorwp' ),
...
new Sejoli_AutomatorWP_Anonymous_Order_Subscription_Regular();