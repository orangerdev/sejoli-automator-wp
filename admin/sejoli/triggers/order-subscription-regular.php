<?php
/**
 * Sejoli Order Subscription Regular
 *
 * @package     AutomatorWP\Integrations\Sejoli\Triggers\Order_Subscription_Regular
...
class Sejoli_AutomatorWP_Order_Subscription_Regular extends AutomatorWP_Integration_Trigger {

    public $integration = 'sejoli';
    public $trigger     = 'sejoli_automatorwp_order_subscription_regular';
...
new Sejoli_AutomatorWP_Order_Subscription_Regular();